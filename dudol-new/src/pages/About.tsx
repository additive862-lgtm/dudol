            ...
            <div className="max-w-4xl mx-auto px-4 py-16 space-y-16">
                ...
                <section className="flex flex-col md:flex-row gap-12 items-start">
                    <div className="w-full md:w-1/3 aspect-[3/4] bg-slate-200 rounded-2xl overflow-hidden shadow-lg relative">
                        {/* Placeholder for Fr. Lee's image */}
                        <div className="absolute inset-0 flex items-center justify-center text-slate-400 bg-slate-100">
                            <span className="text-sm">이석재 신부님 사진</span>
                        </div>
                        {/* If actual image url is available, use img tag */}
                    </div>
                    ...
                    <div className="flex-1 space-y-6">
                        ...
                        <p className="text-slate-700 leading-relaxed">
                            이석재 신부는 '문화 영성을 통한 복음화'를 평생의 화두로 삼아왔습니다.
                            단순한 지식 전달을 넘어, 삶의 구체적인 자리에서 하느님의 말씀을 체험하고
                            기쁨을 나누는 '즐거운 신앙'을 강조합니다.
                        </p>
                    </div>
                </section>
                ...
                {/* Books Section */}
                <section>
                    <h2 className="text-2xl font-bold text-slate-900 mb-8 border-l-4 border-sky-500 pl-4">저서</h2>
                        ...
                        {['신난다 첫영성체 교리', '묻고 답하는 성경 여행', '맘도 몸도 첫번째 성경여행'].map((book) => (
                            <div key={book} className="bg-slate-50 p-6 rounded-xl text-center">
                                <div className="w-16 h-20 bg-white shadow-sm mx-auto mb-4 border border-slate-200 flex items-center justify-center">
                                    <span className="text-xs text-slate-300">표지</span>
                                </div>
